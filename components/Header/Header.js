...
function Header() {
  ...
  return (
    <header className="border-b-0 pt-3 pb-3 border-gray-300 shadow-sm bg-white sticky top-0 z-50">
      <div className="max-w-6xl m-auto">
        <div className="flex justify-between items-center mx-5">
          ...
          <div
            onClick={() => router.push("/")}
            className="relative inline-grid lg:hidden w-10 h-10 flex-shrink-0 cursor-pointer"
          >
            ...
            {session ? (
              <>
                ...
                <img
                  ...
                  alt="profile-picture"
                  className="h-8 rounded-full w-8 md:h-10 md:w-10 cursor-pointer inline-flex"
                />
              </>
            ) : (
